package com.jeeplus.modules.xssj.utils;
...
public class CCustSaleListener extends AnalysisEventListener{
    ...
    public final static List<String> msg = new ArrayList<>();
    ...
    public void invoke(Object object, AnalysisContext context) {
        if(object != null){
            ...
            try {
                ...
                String error = "第"+(data.size()+1) + "行数据有错误，错误数据："+rowList.toString()+",请核对数据";
                msg.add(error);
                e.printStackTrace();
            }
