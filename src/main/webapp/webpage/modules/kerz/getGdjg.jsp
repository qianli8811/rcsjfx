...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="gdfxtj" action="${ctx}/kerz/rcKhzl/getGdjg" method="post" class="form-inline">
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		<thead>
			<tr>
				...
				<th  class="sort-column heji">合计</th>
				<th  class="sort-column gu">股东</th>
				<th  class="sort-column sjkgr">实际控股人</th>
				<th  class="sort-column dbr">担保人</th>
				<th  class="sort-column n">男</th>
				<th  class="sort-column nv">女</th>
				<th  class="sort-column sb">18以下</th>
				<th  class="sort-column ss">18~30</th>
				<th  class="sort-column ts">30~50</th>
				<th  class="sort-column ls">50以上</th>
