		...
		$("#sidebar").click(
			function() {
				...
				if ($(this).hasClass("active")) {
					console.log($("#sidebar li").hasClass("active"));
				}
			}
		);
	});
...
<body class="no-skin">
		...
		<div class="main-container" id="main-container">
			...
			<div class="main-content">
                ...
                <nav class="page-tabs J_menuTabs">
                    <div class="page-tabs-content">
                         <a href="javascript:;" class="active J_menuTab" data-id="${ctx}/monitor/info">首页</a>
                    </div>
                </nav>
           ...
           <%--  <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${ctx}/monitor/info" frameborder="0" data-id="" seamless>--%>
	           <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${ctx}/home" frameborder="0" data-id="" seamless>
				...
				<div class="footer-inner">
					...
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">融创金控云平台-天网信用系统</span>
							 &copy; 2018-2030
						</span>
