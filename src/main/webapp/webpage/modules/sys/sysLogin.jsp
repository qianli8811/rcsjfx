...
<html>
	...
	<head>
		...
		<!-- jeeplus -->
		<link href="${ctxStatic}/common${ctx}.css" type="text/css" rel="stylesheet" />
		<script src="${ctxStatic}/common${ctx}.js" type="text/javascript"></script>
					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							...
							<div class="center">
								<h1>
									<br/>
									<img src="${ctxStatic }/common/login/images/rcsufx_logo.png" style="width:350px">
									<br>
								</h1>
												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text"  id="username" name="username" class="form-control required"  value="rcfx" placeholder="用户名" />
													...
													<div class="space-4"></div>
														<div id="themeSwitch" class="dropdown">
															...
															<ul class="dropdown-menu">
																<li>
																	<a href="#" onclick="location='${pageContext.request.contextPath}/theme/ace?url='+location.href"><font color="black">ACE风格</font>
																	</a>
																</li>
							...
							<div class="center"><h4 id="id-company-text"><font color="#A90E0E">&copy; 融创金控云平台-天网信用系统</font></h4></div>
