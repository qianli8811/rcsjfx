...
<link href="${ctxStatic}/bootstrap/3.3.4/css_default/bootstrap.css" type="text/css" rel="stylesheet" />
...
<link href="${ctxStatic}/layui-v2.2.5/layui/css/layui.css" type="text/css" rel="stylesheet" />
<!-- 引入自定义文件 -->
