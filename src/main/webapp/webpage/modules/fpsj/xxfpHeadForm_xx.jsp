			...
			<div id="tabPage2">
				<div id="tabPage-zzszyfp">
					...
					<table border="0" cellpadding="0" cellspacing="0" style="width:100%">
						<tbody>
						<tr height="30">
							<td class="align_left">发票号码：<span class="content_td_blue" id="fpdm">${xxfpHead.fphm}</span></td>
							<td>&nbsp;</td>
							...
							<td class="align_left"></td>
							<td>&nbsp;</td>
							<td class="align_left" id="jqxx_zp" style="">开票日期：<span class="content_td_blue" id="kprq_zp"><fmt:formatDate value="${xxfpHead.kprq}" pattern="yyyy-MM-dd HH:mm:ss.SSS"/></span></td>
							<td align=right><a target="" href="${ctx}/fpsj/xxfpHead/export">下载</a></td>
						</tr>
						</tbody>
					</table>
					<table style="width:100%" border="0" cellspacing="0" cellpadding="0" class="fppy_table">
						...
						<tr>
							...
							<td nowrap="" class="align_left borderNo bgcolorWhite"><span class="content_td_blue" id="gfmc_zp">${xxfpHead.khmc}</span></td>
							<td rowspan="4" class="align_center" width="20">
								<p>密</p>
								<p>码</p>
								<p>区</p>
						...
						<tr>
							...
							<td nowrap="" class="align_left borderNo"><span class="content_td_blue" id="gfsbh_zp">${xxfpHead.khsh}</span></td>
						</tr>
						<tr>
							<td class="align_left borderNo" valign="top">地址、电话：</td>
							<td class="align_left borderNo" valign="top"><span class="content_td_blue" id="gfdzdh_zp">${xxfpHead.khdz}</span></td>
						</tr>
						<tr>
							<td class="align_left borderNo" valign="top">开户行及账号：</td>
							<td class="align_left borderNo" valign="top"><span class="content_td_blue" id="gfyhzh_zp">${xxfpHead.khkhyhzh} </span></td>
						</tr>
							...
							<td colspan="5">
								<table cellspacing="0" cellpadding="0" style="width:100%;" class="fppy_table_box">
										...
										<c:forEach items="${xxfpItemList}" var="xxfpItem"  varStatus="idx">
											<tr >
												<td class="align_left borderRight">
													<span class="content_td_blue" >${xxfpItem.cpmc}</span>
												</td>
												<td class="align_left borderRight" width="10%">
													<span class="content_td_blue" >${xxfpItem.cpxh}</span>

												</td>
												<td class="align_right borderRight" width="5%">
													<span class="content_td_blue" >${xxfpItem.cpdw}</span>

												</td>
												<td class="align_right borderRight" width="10%">
													<span class="content_td_blue" >${xxfpItem.cpsl}</span>

												</td>

												<td class="align_right borderRight" width="10%">
													<span class="content_td_blue" >${xxfpItem.cpdj}</span>

												</td>
												<td class="align_right borderRight" width="15%">
													<span class="content_td_blue" >${xxfpItem.bhsje}</span>

												</td>
												<td class="align_right borderRight" width="5%">
													<span class="content_td_blue" >${xxfpItem.sl}</span>

												</td>
												<td class="align_right" width="15%">
													<span class="content_td_blue" >${xxfpItem.se}</span>
									...
									<tr id="xiaoji" name="xiaoji">
										...
										<td class="align_center borderRight">&nbsp;</td>
										<td class="align_center borderRight">&nbsp;</td>
										<td class="align_right borderRight"><span class="content_td_blue" id="je_zp">￥${xxfpHead.zbhsje}</span></td>
										<td class="align_center borderRight">&nbsp;</td>
										<td class="align_right"><span class="content_td_blue" id="se_zp">￥${xxfpHead.zse}</span></td>
									</tr>
									<tr>
										...
										<td colspan="3" class="align_left borderTop"><span style="padding:0 20px;">（小写）</span><span class="content_td_blue" id="jshjxx_zp">￥${xxfpHead.jshj}</span></td>
									</tr>
									</tbody>
								</table>
							</td>
						...
						<tr>
							...
							<td class="align_left borderNo"><span class="content_td_blue" id="xfmc_zp">${xxfpHead.qymc}</span></td>
							<td rowspan="4" class="align_center" width="20">
								<p>备</p>
								<p>注</p>
							</td>
							<td rowspan="4" class="align_left content_td_blue" width="350" id="bz_zp" valign="top"><div style="width:350px;height:150px;overflow:scroll">${xxfpHead.bz}</div></td>
						</tr>
						<tr>
							<td class="align_left borderNo">纳税人识别号：</td>
							<td class="align_left borderNo"><span class="content_td_blue" id="xfsbh_zp">${xxfpHead.qysh}</span></td>
						</tr>
						<tr>
							<td class="align_left borderNo">地址、电话：</td>
							<td class="align_left borderNo"><span class="content_td_blue" id="xfdzdh_zp">${xxfpHead.qydz}</span></td>
						</tr>
						<tr>
							<td class="align_left borderNo">开户行及账号：</td>
							<td class="align_left borderNo"><span class="content_td_blue" id="xfyhzh_zp">${xxfpHead.qykhyhzh}</span></td>
						</tr>
						</tbody>
					</table>
